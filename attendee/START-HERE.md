...
**Nothing needs installing.** AutoCAD 2026, Civil 3D 2026, VS Code and a
browser with every major AI assistant one click away are already on this
machine. You can start right now.
...
That's your assistant for the day. Now pick a track.
...
*You'll leave with a plan to run this session yourself — it's easier than it
looks.*
...
Six short pages. Everything in the tracks links back to these, so read them
when you need them — not now.

| Card | When you need it |
| --- | --- |
| [Open the assistant](how-to/open-the-assistant.md) | Right at the start, and any time the chat tab disappears |
| [Get the code into a file](how-to/get-code-into-a-file.md) | Every time the assistant answers — copy, paste, save, `.lsp` |
...
- [Choose your assistant](choose-your-assistant.md) — the full menu of
  assistants on this VM, and how to pick if you're unsure.
- [Boilerplate prompt](boilerplate-prompt.md) — the block you pasted at step 0.
  Come back here every time you open a fresh chat.
